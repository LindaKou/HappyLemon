...
//收款单明细查询函数
        ...
        public double selectGet_date1(DateTime date1, DateTime date2)
        {
            MySqlConnection conn = Util.Util.getConn();
            MySqlDataReader dataReader = null;
            MySqlCommand command = null;
            Shoukuan shou = null;
            double sumget_money=0;
            try
            {
                command = conn.CreateCommand();
                ...
                while (dataReader.Read())
                {
                     sumget_money = dataReader.GetDouble(0);
...
//付款单明细查询
        ...
        public double selectPayfor_date1(DateTime date1, DateTime date2)
        {
            MySqlConnection conn = Util.Util.getConn();
            MySqlDataReader dataReader = null;
            MySqlCommand command = null;
            Fukuan fu = null;
            double sumpayfor_money=0;
            try
            {
                command = conn.CreateCommand();
                ...
                while (dataReader.Read())
                {
                    sumpayfor_money = dataReader.GetDouble(0);
                }
            }
           catch (Exception)
            {
...
//退款单明细查询
        ...
        public List<Tuikuan> selectTuikuan_dateandkehuname(DateTime date1, DateTime date2, string supplier_name)
        {
            ...
            {
                command = conn.CreateCommand();
                command.CommandText = "SELECT * FROM tuikuan_money where date>='" + date1 + "'and date<='" + date2 + "'and tuikuan_suppliernumber='" + supplier_name + "'";
                dataReader = command.ExecuteReader();
                Console.WriteLine();
                while (dataReader.Read())
                {
        ...
        public double selectTuikuan_date1(DateTime date1, DateTime date2)
        {
            MySqlConnection conn = Util.Util.getConn();
            MySqlDataReader dataReader = null;
            MySqlCommand command = null;
            Tuikuan tui = null;
            double sumtuikuan_money=0;
            try
            {
                command = conn.CreateCommand();
                ...
                while (dataReader.Read())
                {
                     sumtuikuan_money = dataReader.GetDouble(0);
                }
           }
            catch (Exception)
            {
